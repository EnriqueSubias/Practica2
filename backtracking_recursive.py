...
print("BackTracking Recursivo")

# BackTracking Recursivo
def func(n, pos_x, pos_y): # anadir mas parametros que hagan falta
    ...
    for (int i = 1; i < n; i++): # n - 1 vueltas
        ...
        pos_x_a = pos_x[0:a] # Array con las posiciones desde la primera hasta la (a + 1)
        pos_y_a = pos_y[0:a]

        pos_x_b = pos_x[a:final] # Array con las posiciones desde la a hasta la final
        pos_y_b = pos_y[a:final]
        ...
        #aux_a = func(a, pos_x_a, pos_y_a)

        #aux_b = func(a, pos_x_b, pos_y_b)

        # if aux_a && aux_b == "impossible"
        #     return "aux_a"
        # coste[i] = aux_a + aux_b
        coste[i] = func(a, pos_x_a, pos_y_a) + func(a, pos_x_b, pos_y_b)

    # Calculo de costes para un solo arco
    coste[n] = calculate_cost_one_arch(punto_inicial[0],  punto_final[ultimo]) # dos puntos del terreno y la altura máxima
